...
export function ResponseField({
    ...
    return (
        <>
            ...
            <div
                id="response-field"
                className={`fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-6 rounded-3xl shadow-xl w-1/3 transition-transform transition-opacity duration-500 ease-in-out z-50 space-y-4 ${
